...
router.post('/create/:idCourse', (0, error_middlewear_1.asyncHandelError)(category_controllers_1.createCategory));
router.put('/:id/update', (0, error_middlewear_1.asyncHandelError)(category_controllers_1.updateCategory));
router.delete('/:id/remove', (0, error_middlewear_1.asyncHandelError)(category_controllers_1.removeCategory));
