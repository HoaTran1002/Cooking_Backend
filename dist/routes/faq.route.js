...
route.post('/create', (0, auth_middlewears_1.authorize)(['ADMIN']), (0, validate_middlewear_1.validator)(faq_validate_1.faqValidate), (0, error_middlewear_1.asyncHandelError)(faq_controller_1.default.createFAQ));
route.put('/:id/update', (0, auth_middlewears_1.authorize)(['ADMIN']), (0, validate_middlewear_1.validator)(faq_validate_1.faqValidate), (0, error_middlewear_1.asyncHandelError)(faq_controller_1.default.editFAQ));
