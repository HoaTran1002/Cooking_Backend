...
router.post('/create', (0, auth_middlewears_1.authorize)(['ADMIN']), (0, validate_middlewear_1.validator)(informationBusiness_validate_1.infoBusinessValidate), (0, error_middlewear_1.asyncHandelError)(informationBusiness_controllers_1.createInformationBusiness));
...
router.patch('/update/:id', (0, auth_middlewears_1.authorize)(['ADMIN']), (0, validate_middlewear_1.validator)(informationBusiness_validate_1.infoBusinessValidate), (0, error_middlewear_1.asyncHandelError)(informationBusiness_controllers_1.updateFormationBusinessById));
