...
route.put('/:id/update', (0, auth_middlewears_1.authorize)(['ADMIN']), (0, validate_middlewear_1.validateBody)(news_validate_1.validateCreateNews), (0, error_middlewear_1.asyncHandelError)(news_controller_1.updateNewsById));
