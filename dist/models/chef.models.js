        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    newPosition = 1;
                    return [4 /*yield*/, mongoose_1.default.model('Chef').findOne({}, 'position').sort({ position: -1 }).exec()];
                case 1:
                    highestCourse = _a.sent();
                    if (highestCourse) {
                        newPosition = highestCourse.position + 1;
                    }
                    return [4 /*yield*/, mongoose_1.default.model('Chef').findOne({ position: newPosition })];
                case 2:
                ...
                case 3:
                    ...
                    return [4 /*yield*/, mongoose_1.default.model('Chef').findOne({ position: testPosition })];
                case 4:
