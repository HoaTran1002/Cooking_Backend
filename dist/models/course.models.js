...
var category_models_1 = __importDefault(require("./category.models"));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    doc = _a.sent();
                    return [4 /*yield*/, product_models_1.default.find({ idCategory: doc._id })];
                case 2:
                    products = _a.sent();
                    if (products.length > 0) {
                        products.map(function (product) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, product_service_1.deleteByIdProduct)(new mongoose_1.default.Types.ObjectId(product.id).toString())];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                    ...
                    return [4 /*yield*/, category_models_1.default.find({ idCourse: doc._id })];
                case 3:
                    categories = _a.sent();
                    if (categories.length > 0) {
                        categories.map(function (category) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, category_service_1.removeCategory)(new mongoose_1.default.Types.ObjectId(category.id).toString())];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
