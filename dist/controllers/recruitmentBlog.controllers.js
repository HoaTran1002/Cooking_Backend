...
var RecruitmentBlog = /** @class */ (function () {
    function RecruitmentBlog() {
    }
    RecruitmentBlog.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, record, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('RecruitmentBlog', req.body);
    ...
    RecruitmentBlog.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('RecruitmentBlog');
    ...
    RecruitmentBlog.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RecruitmentBlog.prototype.deleteById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RecruitmentBlog.prototype.updateById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
...
var RecruitmentBlogController = new RecruitmentBlog();
exports.default = RecruitmentBlogController;
