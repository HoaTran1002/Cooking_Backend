...
var CategoryServicesCustomer = /** @class */ (function () {
    function CategoryServicesCustomer() {
    }
    CategoryServicesCustomer.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, record, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('categoryServiceCategory', req.body);
    ...
    CategoryServicesCustomer.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('categoryServiceCategory');
    ...
    CategoryServicesCustomer.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CategoryServicesCustomer.prototype.deleteById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CategoryServicesCustomer.prototype.updateById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
...
var CategoryServicesCustomerController = new CategoryServicesCustomer();
exports.default = CategoryServicesCustomerController;
