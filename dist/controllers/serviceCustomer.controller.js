...
var ServicesCustomer = /** @class */ (function () {
    ...
    ServicesCustomer.prototype.create = function (req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        instance = index_service_1.default.instance('ServiceCustomer', req.body);
                        return [4 /*yield*/, instance.create((_a = req.file) === null || _a === void 0 ? void 0 : _a.path)];
                    case 1:
                        record = _b.sent();
    ...
    ServicesCustomer.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('ServiceCustomer');
    ...
    ServicesCustomer.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ServicesCustomer.prototype.deleteById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ServicesCustomer.prototype.updateById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('ServiceCustomer', req.body);
                        return [4 /*yield*/, instance.updateById(req.params.id, req.file)];
                    case 1:
                        updated = _a.sent();
...
var ServicesCustomerController = new ServicesCustomer();
exports.default = ServicesCustomerController;
