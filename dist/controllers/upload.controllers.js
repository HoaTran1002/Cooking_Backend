...
var uploadImageFromLocalToS3ByCourseId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var idCourse, course, file, imageObject, Images, courseUpdate;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, upload_service_1.uploadImageS3)(file)];
            case 1:
                imageObject = _a.sent();
                if (!imageObject) {
                    return [2 /*return*/, res.status(500).json({ message: 'upload image failed', imageObject: imageObject })];
                }
                return [4 /*yield*/, (0, course_service_1.addImageToCourse)(idCourse, imageObject)];
            case 2:
                Images = _a.sent();
                if (!Images) {
                    return [2 /*return*/, res.status(500).json({ message: 'upload image failed' })];
                }
                if (!!course.image) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, course_service_1.updateImageFromPopImages)(idCourse, Images)];
            case 3:
                ...
                _a.label = 4;
            case 4: return [2 /*return*/, res.status(200).json({ message: 'upload image success', result: Images })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, course_service_1.getAllImages)(idCourse)];
            case 1:
                result = _a.sent();
                if (!result) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, upload_service_1.getImageS3)(keyImage)];
            case 1:
                result = _a.sent();
                if (!result) {
...
var deleteAllImageFromS3ByCourseId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                course = (_b.sent());
                if (!((_a = course === null || course === void 0 ? void 0 : course.images) === null || _a === void 0 ? void 0 : _a.length)) return [3 /*break*/, 3];
                course.images.map(function (item) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, upload_service_1.deleteImageS3)(item.key.toString())];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                return [4 /*yield*/, (0, course_service_1.updateDeleteAllImages)(idCourse)];
            case 2:
                courseUpdate = _b.sent();
                return [2 /*return*/, res.status(200).json({ message: 'delete image all success', courseUpdate: courseUpdate })];
...
var deleteImageFromS3ByCourseId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var idCourse, keyImage, course, newImages, result;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                idCourse = req.params.idCourse;
                keyImage = req.params.keyImage;
                if (!(idCourse && keyImage)) return [3 /*break*/, 4];
                return [4 /*yield*/, course_models_1.default.findById(idCourse)];
            case 1:
                course = _b.sent();
                newImages = (_a = course === null || course === void 0 ? void 0 : course.images) === null || _a === void 0 ? void 0 : _a.filter(function (item) { return item.key != keyImage; });
                return [4 /*yield*/, (0, upload_service_1.deleteImageS3)(keyImage)];
            case 2:
                _b.sent();
                if (!newImages) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, course_service_1.updateDeleteImage)(idCourse, newImages)];
            case 3:
                result = _b.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!file) return [3 /*break*/, 5];
                return [4 /*yield*/, (0, upload_service_1.uploadVideoS3)(file)];
            case 1:
                videoObject = _a.sent();
                if (!videoObject) {
                    return [2 /*return*/, res.status(500).json({ message: 'upload videoObject failed', videoObject: videoObject })];
                }
                return [4 /*yield*/, (0, course_service_1.addVideoToCourse)(idCourse, videoObject)];
            case 2:
                Videos = _a.sent();
                if (!Videos) {
                    return [2 /*return*/, res.status(500).json({ message: 'upload image failed' })];
                ...
                if (!!course.image) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, course_service_1.updateImageFromPopImages)(idCourse, Videos)];
            case 3:
                courseUpdate = _a.sent();
                if (!courseUpdate) {
                    return [2 /*return*/, res.status(500).json({ message: 'update image failed' })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                idCourse = req.params.idCourse;
                if (!idCourse) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, course_service_1.getAllVideos)(idCourse)];
            case 1:
                result = _a.sent();
                if (!result) {
                    return [2 /*return*/, res.status(400).json({ message: 'invalid params' })];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, upload_service_1.getVideoS3)(keyVideo)];
            case 1:
                result = _a.sent();
                if (!result) {
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                course.videos.map(function (item) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (0, upload_service_1.deleteVideoS3)(item.key.toString())];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                return [4 /*yield*/, (0, course_service_1.updateDeleteAllVideos)(idCourse)];
            case 2:
                courseUpdate = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, upload_service_1.deleteVideoS3)(keyVideo)];
            case 2:
                _b.sent();
                if (!newVideos) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, course_service_1.updateDeleteVideo)(idCourse, newVideos)];
            case 3:
                result = _b.sent();
