...
exports.deleteVideoFromS3ByCourseId = exports.deleteAllVideoFromS3ByCourseId = exports.getVideoFromS3BykeyVideo = exports.getAllVideoFromS3ByCourseId = exports.uploadVideoFromLocalToS3ByCourseId = exports.getImageFromS3BykeyImage = exports.getAllImageFromS3ByCourseId = exports.deleteAllImageFromS3ByCourseId = exports.deleteImageFromS3ByCourseId = exports.uploadImageFromLocalToS3ByCourseId = void 0;
...
const uploadImageFromLocalToS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const Images = yield (0, course_repository_1.addImageToCourse)(idCourse, imageObject);
    if (!Images) {
...
const deleteImageFromS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const courseExist = yield (0, course_service_1.findById)(idCourse);
    if (!courseExist) {
        return res.status(400).json({ message: 'idProduct invalid' });
    }
    const image = yield (0, course_repository_1.findCourseImage)(idCourse, keyImage);
    if (!image) {
        return res.status(400).json({ message: 'keyImage invalid' });
    }
    const course = yield course_models_1.default.findById(idCourse);
    const newImages = (_a = course === null || course === void 0 ? void 0 : course.images) === null || _a === void 0 ? void 0 : _a.filter((item) => item.key != keyImage);
    yield (0, upload_service_1.deleteImageS3)(keyImage);
    if (newImages) {
        const result = yield (0, course_repository_1.updateDeleteImage)(idCourse, newImages);
...
const deleteAllImageFromS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (idCourse) {
        ...
        if ((_b = course === null || course === void 0 ? void 0 : course.images) === null || _b === void 0 ? void 0 : _b.length) {
            course.images.map((item) => __awaiter(void 0, void 0, void 0, function* () {
                yield (0, upload_service_1.deleteImageS3)(item.key.toString());
                yield (0, course_repository_1.updateDeleteCourseImage)(idCourse, item);
            }));
...
const getAllImageFromS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const idCourse = req.params.idCourse;
    if (idCourse) {
        const result = yield (0, course_repository_1.getAllImages)(idCourse);
        if (!result) {
            return res.status(400).json({ message: 'invalid params' });
        }
...
const uploadVideoFromLocalToS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (file) {
        ...
        const Videos = yield (0, course_repository_1.addVideoToCourse)(idCourse, videoObject);
        console.log('add success');
        if (!Videos) {
            return res.status(500).json({ message: 'upload image failed' });
        }
        if (!course.video) {
            const courseUpdate = yield (0, course_repository_1.updateVideoFromPopVideos)(idCourse, Videos);
            if (!courseUpdate) {
...
const getAllVideoFromS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const idCourse = req.params.idCourse;
    if (idCourse) {
        const result = yield (0, course_repository_1.getAllVideos)(idCourse);
        if (!result) {
            return res.status(400).json({ message: 'invalid params' });
        }
...
const deleteAllVideoFromS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (idCourse) {
        ...
        if ((_c = course === null || course === void 0 ? void 0 : course.videos) === null || _c === void 0 ? void 0 : _c.length) {
            ...
            const courseUpdate = yield (0, course_repository_1.updateDeleteAllVideos)(idCourse);
...
const deleteVideoFromS3ByCourseId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (idCourse && keyVideo) {
        ...
        if (newVideos) {
            const result = yield (0, course_repository_1.updateDeleteVideo)(idCourse, newVideos);
