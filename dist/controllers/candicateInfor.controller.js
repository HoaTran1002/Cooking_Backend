...
var CandicateInfor = /** @class */ (function () {
    function CandicateInfor() {
    }
    CandicateInfor.prototype.create = function (req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        instance = index_service_1.default.instance('CandicateInfor', req.body);
    ...
    CandicateInfor.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('CandicateInfor');
    ...
    CandicateInfor.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CandicateInfor.prototype.deleteById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CandicateInfor.prototype.updateById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return CandicateInfor;
}());
var CandicateInforController = new CandicateInfor();
exports.default = CandicateInforController;
