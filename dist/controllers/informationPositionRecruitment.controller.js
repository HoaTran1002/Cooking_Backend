...
var InformationPositionRecruitment = /** @class */ (function () {
    function InformationPositionRecruitment() {
    }
    InformationPositionRecruitment.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, record, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('InformationPopsitionRecruitment', req.body);
                        return [4 /*yield*/, instance.create()];
                    case 1:
                        record = _a.sent();
                        response = new response_interface_1.IResponseSuccessObject('create sucess', record, 200);
                        return [2 /*return*/, res.status(200).json(response)];
                }
            });
        });
    };
    InformationPositionRecruitment.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = index_service_1.default.instance('InformationPopsitionRecruitment');
    ...
    InformationPositionRecruitment.prototype.getById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, data, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    InformationPositionRecruitment.prototype.deleteById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    InformationPositionRecruitment.prototype.updateById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return InformationPositionRecruitment;
}());
var InformationPositionRecruitmentController = new InformationPositionRecruitment();
exports.default = InformationPositionRecruitmentController;
