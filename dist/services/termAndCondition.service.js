...
var termAndCondition_resiroty_1 = __importDefault(require("../repositories/termAndCondition.resiroty"));
var response_interface_1 = require("../contract/interfaces/response.interface");
var TermAndCondition = /** @class */ (function () {
    function TermAndCondition(payload) {
        if (payload) {
    ...
    TermAndCondition.prototype.create = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, termAndCondition_resiroty_1.default.create(body)];
                    case 1:
    ...
    TermAndCondition.prototype.getAll = function (page, size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        limit = size;
                        skip = (page - 1) * size;
                        return [4 /*yield*/, termAndCondition_resiroty_1.default.getAll(limit, skip)];
                    case 1:
                        data = _a.sent();
                        return [4 /*yield*/, termAndCondition_resiroty_1.default.Model.countDocuments()];
                    case 2:
    ...
    TermAndCondition.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, termAndCondition_resiroty_1.default.getById(id)];
                    case 1:
                        customerBlog = _a.sent();
                        return [2 /*return*/, customerBlog];
                    case 2:
    ...
    TermAndCondition.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, termAndCondition_resiroty_1.default.deleteById(id)];
                    case 1:
                        customerBlog = _a.sent();
                        return [2 /*return*/, customerBlog];
                    case 2:
    ...
    TermAndCondition.prototype.updateById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, termAndCondition_resiroty_1.default.update(id, body)];
                    case 1:
                        customerBlog = _a.sent();
                        return [2 /*return*/, customerBlog];
                    case 2:
...
exports.default = TermAndCondition;
