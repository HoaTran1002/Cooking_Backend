...
var serviceCustomer_repository_1 = __importDefault(require("../repositories/serviceCustomer.repository"));
var file_service_1 = require("./file.service");
var ServicesCustomer = /** @class */ (function () {
    function ServicesCustomer(payload) {
        if (payload) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, serviceCustomer_repository_1.default.create(body)];
                    case 1:
                        record = _a.sent();
    ...
    ServicesCustomer.prototype.getAll = function (page, size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        limit = size;
                        skip = (page - 1) * size;
                        return [4 /*yield*/, serviceCustomer_repository_1.default.getAll(limit, skip)];
                    case 1:
                        data = _a.sent();
                        return [4 /*yield*/, serviceCustomer_repository_1.default.Model.countDocuments()];
                    case 2:
    ...
    ServicesCustomer.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var record, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, serviceCustomer_repository_1.default.getById(id)];
                    case 1:
                        record = _a.sent();
                        return [2 /*return*/, record];
                    case 2:
    ...
    ServicesCustomer.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var record, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, serviceCustomer_repository_1.default.deleteById(id)];
                    case 1:
                        record = _a.sent();
                        return [2 /*return*/, record];
                    case 2:
    ...
    ServicesCustomer.prototype.updateById = function (id, file) {
        return __awaiter(this, void 0, void 0, function () {
            var existed, body, record, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 9, , 12]);
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7: return [4 /*yield*/, serviceCustomer_repository_1.default.update(id, body)];
                    case 8:
                        record = _a.sent();
                        return [2 /*return*/, record];
                    case 9:
...
exports.default = ServicesCustomer;
