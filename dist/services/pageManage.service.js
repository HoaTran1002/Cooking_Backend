...
var pageManage_repository_1 = __importDefault(require("../repositories/pageManage.repository"));
var response_interface_1 = require("../contract/interfaces/response.interface");
var file_service_1 = require("./file.service");
var PagaManageService = /** @class */ (function () {
    function PagaManageService(payload) {
        if (payload) {
    ...
    PagaManageService.prototype.create = function (path) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, pageManage_repository_1.default.create(body)];
                    case 1:
                        partner = _a.sent();
    ...
    PagaManageService.prototype.getAll = function (page, size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        limit = size;
                        skip = (page - 1) * size;
                        return [4 /*yield*/, pageManage_repository_1.default.getAll(limit, skip)];
                    case 1:
                        data = _a.sent();
                        return [4 /*yield*/, pageManage_repository_1.default.Model.countDocuments()];
                    case 2:
    ...
    PagaManageService.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var partner, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, pageManage_repository_1.default.getById(id)];
                    case 1:
                        partner = _a.sent();
                        return [2 /*return*/, partner];
                    case 2:
    ...
    PagaManageService.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var partner, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, pageManage_repository_1.default.deleteById(id)];
                    case 1:
                        partner = _a.sent();
                        return [2 /*return*/, partner];
                    case 2:
    ...
    PagaManageService.prototype.updateById = function (id, file) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (!(file && this.baner.url)) return [3 /*break*/, 6];
                        return [4 /*yield*/, (0, file_service_1.updateFileContent)(file, this.baner.url)];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
                        ...
                        _a.label = 7;
                    case 7: return [4 /*yield*/, pageManage_repository_1.default.update(id, payload)];
                    case 8:
                        partner = _a.sent();
                        return [2 /*return*/, partner];
                    case 9:
    ...
    return PagaManageService;
}());
exports.default = PagaManageService;
