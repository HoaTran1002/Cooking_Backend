...
const findCourseImage = (idCourse, key) => __awaiter(void 0, void 0, void 0, function* () {
    const courseImages = yield course_models_1.default.aggregate([
        {
            $match: {
...
const updateDeleteCourseImage = (idCourse, image) => __awaiter(void 0, void 0, void 0, function* () {
    const fillter = { _id: idCourse };
