...
class CategoryServicesCustomer {
  ...
  async getAll(req: Request<any, unknown, IInformationPosition>, res: Response) {
    const instance = FactoryService.instance<IInformationPosition>('InformationPopsitionRecruitment')
  ...
  async getById(req: Request<any, unknown, IInformationPosition>, res: Response) {
    const instance = FactoryService.instance<IInformationPosition>('InformationPopsitionRecruitment')
    const data = await instance!.getById(req.params.id)
    const response = new IResponseSuccessObject('get By id success', data, 200)
    return res.status(200).json(response)
  }
  async deleteById(req: Request<any, unknown, IInformationPosition>, res: Response) {
    const instance = FactoryService.instance<IInformationPosition>('InformationPopsitionRecruitment')
  ...
  async updateById(req: Request<any, unknown, IInformationPosition>, res: Response) {
    const instance = FactoryService.instance<IInformationPosition>('InformationPopsitionRecruitment', req.body)
