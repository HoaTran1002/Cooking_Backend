...
class RecruitmentBlog {
  async create(req: Request<unknown, unknown, IRecruitmentBlog>, res: Response) {
    const instance = FactoryService.instance<IRecruitmentBlog>('RecruitmentBlog', req.body)
    const record = await instance!.create()
    const response = new IResponseSuccessObject('create sucess', record, 200)
    return res.status(200).json(response)
  }
  async getAll(req: Request<any, unknown, IRecruitmentBlog>, res: Response) {
    const instance = FactoryService.instance<IRecruitmentBlog>('RecruitmentBlog')
  ...
  async getById(req: Request<any, unknown, IRecruitmentBlog>, res: Response) {
    const instance = FactoryService.instance<IRecruitmentBlog>('RecruitmentBlog')
    const data = await instance!.getById(req.params.id)
    const response = new IResponseSuccessObject('get By id success', data, 200)
    return res.status(200).json(response)
  }
  async deleteById(req: Request<any, unknown, IRecruitmentBlog>, res: Response) {
    const instance = FactoryService.instance<IRecruitmentBlog>('RecruitmentBlog')
  ...
  async updateById(req: Request<any, unknown, IRecruitmentBlog>, res: Response) {
    const instance = FactoryService.instance<IRecruitmentBlog>('RecruitmentBlog', req.body)
