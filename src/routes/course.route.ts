...
router.post('/:courseId/roadmap/create', authorize(), validateBody<IRoadmap>(roadmapValidate), asyncHandelError(courseCreateRoadmap))

router.put('/:courseId/update', authorize(), validateBody<ICourse>(courseValidate), asyncHandelError(courseUpdateById))
router.put('/:courseId/roadmap/:roadmapId/update', authorize(), validateBody<IRoadmap>(roadmapValidate), asyncHandelError(updateRoadmapById))
