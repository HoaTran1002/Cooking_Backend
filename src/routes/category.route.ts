...
router.post('/create/:idCourse', authorize(['ADMIN']), asyncHandelError(createCategory))
router.put('/:id/update', authorize(['ADMIN']), asyncHandelError(updateCategory))
router.delete('/:id/remove', authorize(['ADMIN']), asyncHandelError(removeCategory))
router.get('/getAll', asyncHandelError(getAll))
router.get('/getAllByCourseId/:idCourse', asyncHandelError(getAllByCourseId))
